package crypto.cert.bouncycastle;
...
public class Certificate {
     ...
     */
    public static X509Certificate createAcIssuerCert(PublicKey pubKey, PrivateKey privKey) throws Exception {
        ...
        //X509Certificate cert = v1CertGen.generateX509Certificate(privKey);	// deprecated
    ...
    /**
     * Generate a certificate signed by CA's intermediate certficate
     */
	public static X509Certificate createClientCert(PublicKey pubKey, PrivateKey caPrivKey, PublicKey caPubKey) throws Exception {
        ...
        //X509Certificate cert = v3CertGen.generateX509Certificate(caPrivKey);	// deprecated
    ...
    public static void main(String args[]) throws Exception {
        ...
        PrivateKey caPrivKey = factory.generatePrivate(caPrivKeySpec);
        PublicKey caPubKey = factory.generatePublic(caPubKeySpec);
        ...
        // and the attribute certificate. This is to make the code simpler to read, in practice
        ...
        // Instantiate a new attribute certificate generator
        ...
        // serial number (as it's an example we don't have to keep track of the serials anyway
        ...
        //X509V2AttributeCertificate att = (X509V2AttributeCertificate)acGen.generateCertificate(caPrivKey, "BC");	// deprecated
        X509V2AttributeCertificate att = (X509V2AttributeCertificate)acGen.generate(caPrivKey, "BC");

        /*
         *  parse the newly generated AC
         */
        // Holder
        ...
        for (int i = 0; i < attribs.length; i++) {
            ...
            // check for the presence of a 'RoleSyntax' attribute
